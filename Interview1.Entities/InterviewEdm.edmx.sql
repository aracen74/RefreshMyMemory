...
-- --------------------------------------------------
-- Date Created: 12/02/2015 18:50:34
-- Generated from EDMX file: C:\dev\Interview1\Interview1.Entities\InterviewEdm.edmx
-- --------------------------------------------------
...
IF OBJECT_ID(N'[dbo].[FK_OrderProduct]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[LineItems] DROP CONSTRAINT [FK_OrderProduct];
GO
